...
import ru.multisys.client.domain.ResponseTdApiCreate;
import ru.multisys.client.domain.ResponseTdApiInviteUrl;
...
@Log4j2
@Component
public final class TdlibRunner {
...
//        client.send(new TdApi.GetChat(Long.parseLong("-1001271343429")), new GetChat());
//        while (lastMessage_id == 0) {
//            Thread.sleep(1000);
//        }
//
//        client.send(new TdApi.GetMessage(Long.parseLong("-1001271343429"), lastMessage_id), new GetMessage());
//        int counter = 0;
//
//        while (counter < 100) {
//            Thread.sleep(1000);
...
//        client.send(new TdApi.GetChat(getChatId(commands[1])), defaultHandler);
        ...
        TdApi.CreateNewBasicGroupChat newGroup = new TdApi.CreateNewBasicGroupChat(nums, fullGroupName, 0);
        ...
        if (responseTdApiCreate.getChat() != null) {
            ...
            TdApi.SetChatMemberStatus admin =
                    new TdApi.SetChatMemberStatus(responseTdApiCreate.getChat().id, new TdApi.MessageSenderUser(botId), new TdApi.ChatMemberStatusAdministrator("botAdministrator", true, new TdApi.ChatAdministratorRights(true, true, true, true, true, true, true, true, true, true, true, true, true, true, true)));
...
//        System.out.println("First " + limit + " chat(s) out of " + mainChatList.size() + " known chat(s):");
    ...
    private static class GetMessage implements Client.ResultHandler {
        @Override
        public void onResult(TdApi.Object object) {
            try {
    ...
    static long lastMessage_id = 0L;
    private static class GetChat implements Client.ResultHandler {
        @Override
        public void onResult(TdApi.Object object) {
            try {
                TdApi.Chat caht = (TdApi.Chat) object;
                lastMessage_id = caht.lastMessage.id;
            } catch (Exception ignored) {
            }
        }
    }
    ...
    private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        if (authorizationState != null) {
            TdlibRunner.authorizationState = authorizationState;
        }
        switch (TdlibRunner.authorizationState.getConstructor()) {
            case TdApi.AuthorizationStateWaitTdlibParameters.CONSTRUCTOR:
                TdApi.SetTdlibParameters request = new TdApi.SetTdlibParameters();
                request.databaseDirectory = "ru/multisys/client/tdlib";
            ...
            case TdApi.AuthorizationStateWaitOtherDeviceConfirmation.CONSTRUCTOR: {
                String link = ((TdApi.AuthorizationStateWaitOtherDeviceConfirmation) TdlibRunner.authorizationState).link;
            ...
            case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
                ...
                break;
            default:
                System.err.println("Unsupported authorization state:" + newLine + TdlibRunner.authorizationState);
        }
    }
